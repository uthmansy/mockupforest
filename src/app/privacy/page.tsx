      ...
      <main className="max-w-3xl mx-auto py-16 prose prose-neutral">
        <div className="prose mx-auto max-w-4xl p-6">
          ...
          <p>
            ...
            protected when you use our website. By using our site, you agree to
            this policy.
          </p>

          <h3>1. Information We Collect</h3>
          <ul>
            <li>We do not require account registration to download mockups.</li>
            <li>
              We may collect non-personal information automatically, such as
              browser type, device information, and IP address, to improve site
              performance.
            </li>
            <li>
              If you contact us, we may store your email and message to respond
              to your inquiry.
            </li>
          </ul>
          ...
          <p>
            ...
            improve services. You can disable cookies in your browser settings,
          ...
          <p>
            Ads or external links on the site may lead to third-party websites.
