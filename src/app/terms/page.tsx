    ...
    <Container>
      <main className="max-w-3xl mx-auto py-16 prose prose-neutral">
        ...
        <div className="prose prose-lg text-gray-700 max-w-none">
          <p>
            Welcome to <strong>MockupForest.com</strong>. By accessing or using
            this website, you agree to the following Terms of Service. Please
            read them carefully before using the resources.
          </p>
          ...
          <p>
            ...
            <strong>personal and commercial projects</strong>. You may download,
            edit, and incorporate them into your designs, client work, and
            products.
          </p>
          ...
          <ul>
            ...
            <li>
              Direct file linking (hotlinking) or offering the files as your own
          ...
          <h3>5. Termination</h3>
          <p>
            I reserve the right to restrict or terminate access to this site and
            its resources if you violate these Terms.
          </p>

          <h3>6. Changes to Terms</h3>
          <p>
            I may update these Terms of Service from time to time. Changes will
            take effect immediately upon posting on this page.
          </p>
